...
const AdminSignup = () => {
  const notify=()=>toast.error('Admin already exists!', {
    position: "top-center",
    autoClose: 5000,
  ...
  const notify2=()=>toast.error('Confirm Password should be same Password!', {
    position: "top-center",
    autoClose: 5000,
    hideProgressBar: false,
    closeOnClick: true,
  ...
  const handleOnSubmit=(e)=>{
    ...
    if(password==cpassword){
      ...
      .then(data=>navigate('/admin/signin')).catch(err=>notify())
    }
    else{
      notify2()
    }
